...
public class IPSeeker {
	...
	// 保存的文件夹
	private String INSTALL_DIR = "E:/IPAdd";
	...
	public static void main(String args[]){
		IPSeeker ooIpSeeker = new IPSeeker("qqwry.dat");
		System.out.println(ooIpSeeker.getCountry("61.135.169.125"));
	}
	...
	public IPSeeker(String fileName) {
		...
		try {
			...
			String path = IPSeeker.class.getClassLoader().getResource(this.IP_FILE).getPath();
	...
	private String readString(long offset) {
		try {
			...
			for (i = 0, buf[i] = ipFile.readByte(); buf[i] != 0; buf[++i] = ipFile
				...
				;
			if (i != 0)
				return new String(Util.getString(buf, 0, i, "ISO-8859-1").getBytes("ISO-8859-1"), "GBK");
				return Util.getString(buf, 0, i, "ISO-8859-1");
