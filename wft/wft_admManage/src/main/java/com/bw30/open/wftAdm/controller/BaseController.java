...
public class BaseController {
	 ...
	 * @return
	 */
	protected JsonModel constructJsonModel(Object object, Pager pager) {
		JsonModel jsonModel = new JsonModel();
		jsonModel.setPage(pager.getPageIndex());
		jsonModel.setRecords(pager.getRecCount());
		jsonModel.setTotal(pager.getPageCount());
		jsonModel.setRows(object);
		return jsonModel;
	}
...
//			response.setCharacterEncoding("UTF-8");
			response.setContentType("applation/json");
