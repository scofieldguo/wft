...
<center>
<%
final String uri = "/queryBalance.do";
String submit = request.getParameter("submit");
if (submit == null) {
%>
<h1>测试接口：查询卡剩余时长</h1>
<form action="queryBalance.jsp" method="post">
...
<%
	...
	String result = new com.bw30.open.cardpool.test.ApiTest().testQueryBalance(url, 
