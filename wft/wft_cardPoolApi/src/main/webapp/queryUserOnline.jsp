...
<center>
<%
final String uri = "/queryUserOnline.do";
String submit = request.getParameter("submit");
if (submit == null) {
%>
<h1>测试接口：用户在线状态查询接口</h1>
<form action="queryUserOnline.jsp" method="post">
...
<%
	...
	String result = new com.bw30.open.cardpool.test.ApiTest().testQueryUserOnline(url, 
