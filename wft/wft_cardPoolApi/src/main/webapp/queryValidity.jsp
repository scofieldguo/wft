...
<center>
<%
final String uri = "/queryValidity.do";
String submit = request.getParameter("submit");
if (submit == null) {
%>
<h1>测试接口：查询卡有效期</h1>
<form action="queryValidity.jsp" method="post">
...
<%
	...
	String result = new com.bw30.open.cardpool.test.ApiTest().testQueryValidity(url, 
