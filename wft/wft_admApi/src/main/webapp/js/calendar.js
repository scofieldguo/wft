...
var divs = [];
divs[divs.length] = '<div id="__calendarPanel" style="z-index:9999;position:absolute;display:none;background-color:#FFFFFF;border:1px solid #666666;width:200px;height:224px;">';
divs[divs.length] = '<iframe name="__calendarIframe" id="__calendarIframe" width="100%" height="100%" scrolling="no" frameborder="0" style="margin:0px;position:absolute;z-index:999;"><\/iframe>';
